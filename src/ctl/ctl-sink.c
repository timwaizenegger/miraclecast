...
static void sink_handle_get_parameter(struct ctl_sink *s,
     ...
     *
     * example 720p30: 28 00 02 02 00000020 00000000 00000000 00 0000 0000 00 none none
     *
     * profile 20, level 20 seems to work well with common resolutions
     * profile 03, level 10 works with some low resolutions/old devices
     *
     * */
    if (rtsp_message_read(m, "{<>}", "wfd_video_formats") >= 0) {
        char wfd_video_formats[128];
        sprintf(wfd_video_formats,
                "wfd_video_formats: 00 00 02 02 %08x %08x %08x 00 0000 0000 00 none none",
